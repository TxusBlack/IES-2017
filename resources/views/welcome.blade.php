    ...
    <div class="parallax">
        <div class="container">
            ...
            <div class="col-lg-8 col-md-8 col-sm-8 img_banner">
                ...
                <a><img class="margin-playstore playstore" href="https://play.google.com/store/apps/details?id=com.unisangil.ies" target="__blank" src="/img/playstore.png" alt="PlayStore" class="img-responsive" width="236px" height="100%" border="none"></a>
            </div>
        </div>
    </div>
</div>
